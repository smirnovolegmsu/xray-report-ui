...
ALIASES_PATH = STATE_DIR / "user_aliases.json"      # {"user_01":"Ivan", ...}
SETTINGS_PATH = STATE_DIR / "ui_settings.json"      # {"public_host":"...", "reality_template": {...}}
...
# =============================================================================
# Xray Reality template & link generation
# =============================================================================
...
def make_vless_link(user_email: str, user_uuid: str, host: Optional[str] = None) -> str:
    ...
    # Важно: никаких spx. Только нужные параметры + pbk корректный.
    return (
...
# =============================================================================
# Dashboard aggregation (last N days)
# =============================================================================
...
# =============================================================================
# Admin: users & aliases + all-time stats
# =============================================================================
...
# =============================================================================
# System commands via screen "vpn"
# =============================================================================
def _run_in_screen(tag: str, cmd: str, timeout_s: float = 4.0) -> Dict[str, Any]:
    ...
    # Важно: выполняем в screen с именем "vpn" (как ты просил)
...
# =============================================================================
# Sessions (heuristic) from access log
# =============================================================================
...
def sessions_day(target_ymd: str, gran_min: int = 5) -> Dict[str, Any]:
    ...
    return {
        ...
        "note": "Онлайн оценивается по событиям access.log (подключения/запросы). Это не «идеальные сессии», но хорошо показывает «был трафик / не было».",
    }
